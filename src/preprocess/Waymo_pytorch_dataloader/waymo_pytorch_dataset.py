...
import Waymo_pytorch_dataloader.dataset_utils.calibration_waymo as calibration
import Waymo_pytorch_dataloader.dataset_utils.object3d as object3d
...
class WaymoDataset(Dataset):
    ...
    '''
    def __init__(self, root_dir, split='train', use_cache=False, name="Waymo"):
        self._name=name
        self.split = split
        is_test = self.split == 'test'
        
        self._dataset_dir = os.path.join(root_dir, 'testing' if is_test else 'training')
        ...
        self._dataset_itr = 0# tfRecord iterator
        self.num_sample = self._num_frames
    ...
    def get_file_names(self):
        self.__file_names = []
        for i in os.listdir(self._dataset_dir):
